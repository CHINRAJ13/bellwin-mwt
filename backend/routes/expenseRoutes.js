...
const { getNextExpenseId, createExpense, getExpenses, getExpenseById, updateExpense, deleteExpense, getExpenseReport, approveExpense } = require('../controllers/expenseController');
...
router.put('/status/:id', protect, approveExpense);
